...
type Subscriber interface {
	SubscribeToKNoTMessages(replyToAuthMessages string, queue string, msgChan chan InMsg) error
}
...
func (ms *msgSubscriber) SubscribeToKNoTMessages(replyToAuthMessages string, queueName string, msgChan chan InMsg) error {
	var err error
