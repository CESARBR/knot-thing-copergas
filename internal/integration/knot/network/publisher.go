...
type Publisher interface {
	...
	PublishDeviceAuth(replyToAuthMessages string, userToken string, device *entities.Device) error
...
func (mp *msgPublisher) PublishDeviceAuth(replyToAuthMessages string, userToken string, device *entities.Device) error {
	options := MessageOptions{
		Authorization: userToken,
		Expiration:    defaultExpirationTime,
